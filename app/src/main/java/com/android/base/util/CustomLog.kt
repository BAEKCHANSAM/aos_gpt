...
object CustomLog {
    ...
    @Synchronized
    fun useTags(tags: Array<String>): CustomLog? {
        mUseTags = tags
        return null
    }

    @Synchronized
    fun level(minLevel: Int): CustomLog? {
        mMinLevel = minLevel
        return null
    }

    @Synchronized
    fun useFormat(yes: Boolean): CustomLog? {
        mUseFormat = yes
        return null
    }

    @Synchronized
    fun usePrinter(p: Printer, on: Boolean = true): CustomLog? {
        if (on) {
            mPrinters.add(p)
        } else {
            mPrinters.remove(p)
...
@Synchronized
fun v(msg: Any?, vararg args: Any?): CustomLog? {
    CustomLog.oslLog(CustomLog.V, CustomLog.mUseFormat, msg, *args)
    return null
}

@Synchronized
fun d(msg: Any?, vararg args: Any?): CustomLog? {
    CustomLog.oslLog(CustomLog.D, CustomLog.mUseFormat, msg, *args)
    return null
}

@Synchronized
fun d(msg: Function0<*>) {
    CustomLog.oslLog(CustomLog.D, CustomLog.mUseFormat, msg)
}

@Synchronized
fun i(msg: Any?, vararg args: Any?): CustomLog? {
    CustomLog.oslLog(CustomLog.I, CustomLog.mUseFormat, msg, *args)
    return null
}

@Synchronized
fun w(msg: Any?, vararg args: Any?): CustomLog? {
    CustomLog.oslLog(CustomLog.W, CustomLog.mUseFormat, msg, *args)
    return null
}

@Synchronized
fun e(msg: Any?, vararg args: Any?): CustomLog? {
    CustomLog.oslLog(CustomLog.E, CustomLog.mUseFormat, msg, *args)
    return null
}

@Synchronized
fun v(): CustomLog? {
    CustomLog.oslLog(CustomLog.V, CustomLog.mUseFormat, null)
    return null
}

@Synchronized
fun d(): CustomLog? {
    CustomLog.oslLog(CustomLog.D, CustomLog.mUseFormat, null)
    return null
}

@Synchronized
fun i(): CustomLog? {
    CustomLog.oslLog(CustomLog.I, CustomLog.mUseFormat, null)
    return null
}

@Synchronized
fun w(): CustomLog? {
    CustomLog.oslLog(CustomLog.W, CustomLog.mUseFormat, null)
    return null
}

@Synchronized
fun e(): CustomLog? {
    CustomLog.oslLog(CustomLog.E, CustomLog.mUseFormat, null)
    return null
}